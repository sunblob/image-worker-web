...
export function Sidebar() {
  ...
  return (
    <TooltipProvider delay={0}>
      <aside
        className="hidden md:flex flex-col shrink-0 sticky top-0 h-screen border-r border-border bg-card overflow-hidden transition-[width] duration-200 ease-in-out"
